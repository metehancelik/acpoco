				...
				<Card className="p-6">
					...
					<div className="mt-4">
						...
						<textarea
							...
							className="w-full h-32 px-3 py-2 border border-gray-300 rounded-md focus:outline-hidden focus:ring-2 focus:ring-blue-500"
							required
						/>
					</div>
					...
					<div className="grid grid-cols-1 gap-4 mt-4">
						<div>
							...
							<select
								...
								className="w-full h-9 px-3 py-1 border border-gray-300 rounded-md focus:outline-hidden focus:ring-2 focus:ring-blue-500"
								required
							>

...
const AddToFavoritesButton = ({ productId }: AddToCartButtonProps) => {
  ...
  return (
    <button
      ...
      className="flex max-w-xs flex-1 items-center space-x-2 justify-center rounded-md border border-transparent bg-slate-700 px-8 py-3 text-base font-medium text-white hover:bg-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50 sm:w-full"
    >
      <p>Favoriye Ekle</p>

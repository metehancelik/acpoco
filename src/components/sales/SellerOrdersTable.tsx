  ...
  const renderStatus = (status: string) => {
    ...
    if (status === "waitingPayment") {
      return (
        <p
          className={
            "py-2 px-4 bg-sageBlue text-white rounded-md text-center font-bold"
          }
        >
          {formatStatus(status) || "Ödeme Bekliyor"}
        </p>
                        ...
                        <div className="flex space-x-2 justify-center items-center">
                          <button
                            ...
                            className={classNames(
                              order.giftMessage
                                ? "bg-sageOrange hover:bg-secondary"
                                : "bg-slate-400",
                          ...
                          <button
                            ...
                            className={
                              "bg-sageOrange hover:bg-secondary text-white rounded-md px-1 py-1 font-bold"
                            }
                          >
                            <Tooltip
                              style={{
                        ...
                        {!order.labelUrl ? (
                          <>
                            <label
                              ...
                              className="flex items-center gap-2 text-xs text-white bg-sageOrange rounded-md px-2 py-1 cursor-pointer"
                            >
                        ...
                        <div className="w-full flex justify-center items-center gap-2">
                          {order?.status === "waitingPayment" && (
                            <button
                              ...
                              className="bg-sageBlue text-white rounded-md px-4 py-1 font-bold"
                            >
                              Ödeme Yap
                            </button>
                          )}

...
const PublicNavbar = () => {
	...
	return (
		<div>
				...
				<div className="flex grow gap-y-5 overflow-y-auto cursor-default max-w-6xl mx-auto w-full justify-between">
					...
					<div className="flex items-center space-x-3">
						{!session?.data && (
							<Link
								href="/login"
								className="text-[#777] hover:text-gold flex items-center mr-4 space-x-2"
							>
			...
			<div className="sticky top-0 z-40 flex items-center gap-x-6 bg-[#D2AA5C] px-4 py-4 shadow-xs sm:px-6 lg:hidden">
				<button
					type="button"
